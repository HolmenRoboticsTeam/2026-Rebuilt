...
public class TurretDistanceCalc {
  ...
  private static void loadRealValues() {
    ...
    hubDataPoints =
        new ArrayList<>(
            Arrays.asList(
                ...
                new TurretShotData(
                    Inches.of(76.5), 1640.0 + 100.0, 0.0, 0.861), // Time of flight verified
                new TurretShotData(Inches.of(88.5), 1700.0 + 100.0, 0.0, 0.911),
                new TurretShotData(Inches.of(100.5), 1750.0 + 100.0, 0.0, 0.931),
                new TurretShotData(Inches.of(112.5), 1810.0 + 100.0, 0.0, 0.989),
                new TurretShotData(Inches.of(124.5), 1880.0 + 100.0, 0.0, 1.045),
                new TurretShotData(Inches.of(133.5), 1920.0 + 100.0, 0.0, 1.054),
                new TurretShotData(
                    Meters.of(3.65),
                    1960.0 + 100.0,
                    0.0,
                    1.098), // predicted time of flight (recheck)
    ...
    groundDataPoints =
        new ArrayList<>(Arrays.asList(new TurretShotData(Meters.of(5.0), 2000.0, 0.0, 1.5)));
